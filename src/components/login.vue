        ...
        <div class="container">
            <section id="content">
                <form action="">
                    <h1>用户登录</h1>
                    <div>
                        <input type="text" placeholder="用户" required="" id="username" v-model="form_data.UserName"/>
                    </div>
                    <div>
                        <input type="password" placeholder="密码" required="" id="password" v-model="form_data.PassWord"/>
                    </div>
                    <div class="">
                        <span class="help-block u-errormessage" id="js-server-helpinfo">&nbsp;</span></div>
                    <div>
                        <!-- <input type="submit" value="Log in" /> -->
                        <input type="button" value="登录" class="btn btn-primary" id="js-btn-login" @click="submit"/>
                        <!-- <a href="#">Register</a> -->
                    </div>
                </form><!-- form -->
                <div class="button">
...
.button a {
	background: url(../assets/8bcLQqF.png) 0 -112px no-repeat;
	color: #7E7E7E;
	font-size: 17px;
